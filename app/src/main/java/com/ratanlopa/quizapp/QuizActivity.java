...
import com.ratanlopa.quizapp.databinding.ActivityQuizBinding;
...
public class QuizActivity extends AppCompatActivity {
    ...
    ActivityQuizBinding binding; // View Binding object
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button quizBtn = binding.quizBtn;
    ...
    void quitQuiz() {
        // Navigate back to the main menu activity (replace "MainMenuActivity.class" with your main menu activity)
